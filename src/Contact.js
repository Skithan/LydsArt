...
const Contact = () => (
  <section id="contact" className="contact-section" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '3rem' }}>
    <a 
      ...
      style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#fff', textDecoration: 'none', fontWeight: 500, gap: '1rem', padding: '1rem 2rem', background: 'rgba(34,44,54,0.7)', borderRadius: '1rem', boxShadow: '0 2px 12px #0006' }}
    >
